...
export const Matches = () => {
   ...
   const [selectedMatches, setSelectedMatches] = useState(2011);
   ...
   const yearsForPicker = () => {
      let pickerYears = years.map((year, index) => {
   ...
   return (
      <View>
         ...
         {yearsForPicker()}
         {/* <Button style={styles.button} onPress={updateYear} title="updateYear" color="green"/> */}
